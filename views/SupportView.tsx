    ...
    <div className="max-w-7xl mx-auto space-y-8">
       ...
       <section className="bg-white dark:bg-slate-850 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
          ...
          <div className="prose dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
            <p>Welcome to the <strong>Accsafe</strong> documentation. This guide will help you manage your browser profiles securely.</p>
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-4">Getting Started</h3>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Create a new profile by clicking the "+" button in the dashboard.</li>
              <li>Configure your hardware fingerprints in the "Hardware" tab.</li>
              <li>Assign a proxy to ensure your IP address is masked.</li>
            </ul>
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-4">Troubleshooting</h3>
            <p>If a profile fails to open, check if the proxy status is active. You can re-check proxies in the Proxy Manager.</p>
          </div>
       </section>
    </div>
  );
